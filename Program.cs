...
builder.Services.AddScoped<ICharacterService, CharacterService_DB>();
builder.Services.AddScoped<IWeaponService, WeaponService>();
builder.Services.AddScoped<ISkillService, SkillService_DB>();
builder.Services.AddScoped<IFightService, FightService_DB>();
